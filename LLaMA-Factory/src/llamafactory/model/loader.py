...
from .utils.mod import convert_pretrained_model_to_mod, load_mod_pretrained_model, convert_pretrained_llama_to_mod
...
def load_model(
    ...
    if model is None and not lazy_load:
        ...
        if model_args.mixture_of_depths == "convert":
            #print(model)
            model = convert_pretrained_llama_to_mod(model, config, model_args)
            #print(model_args)
