...
class TransformerDecoder(nn.Module):
    ...
    def router_judgement(self, x, previous_x, 
        ...
        if exp_tag == 'sim_score' or exp_tag == 'random':
            ...
            pre_attn_score = pre_attn_score * (-1)
        ...
        if impl == 'topk':
            if first_inital_flag == False:
                ...
                if exp_tag == 'random':
                    ...
                    random_ruler = random_ruler[:len(skip_indices)]
                    skip_indices = torch.tensor([random_ruler], dtype = skip_indices.dtype, device = skip_indices.device)
    ...
    def forward(
        ...
        *,
        ...
        # ============================================================
        prefix_protected_number = 0 # number of protected prefix-tokens.
        postfix_protected_number = 0 # number of protected postfix-tokens.
        repick_for_sr_ensurance = True
        self.exp_tag = 'attn_map' # ['random', 'sim_score', 'attn_map']
        ...
        if len(self.sparse_ratio_logger) % 10000 == 0:
